...
const changePasswordToggleBtn = document.getElementById(
...
const confirmNewPasswordHint = document.getElementById(
...
const deleteAccountToggleBtn = document.getElementById(
    "delete-account-toggle-btn",
);
...
const deleteConfirmPasswordHint = document.getElementById(
    "delete-confirm-password-hint",
);
const deleteAccountConfirmBtn = document.getElementById(
    "delete-account-confirm-btn",
);
const deleteAccountCancelBtn = document.getElementById(
