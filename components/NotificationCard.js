...
const TYPE_CONFIG = {
	COMMENT: { icon: "icon-comment", colorClass: "type-comment", label: "commented on your post" },
	LIKE: { icon: "icon-heart-fill", colorClass: "type-like", label: "liked your post" },
	FOLLOW: { icon: "icon-person", colorClass: "type-follow", label: "started following you" },
};
...
export function NotificationCard({ notification }) {
	...
	return (
		<a className="notification-card" href={href}>
